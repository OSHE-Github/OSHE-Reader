...
static const char *style_names[] = { "button_light", "screen_light" };
...
ext_font_desc_t fonts[] = {
    { "noto_serif", &ui_font_noto_serif },
    { "noto_serif_italic", &ui_font_noto_serif_italic },
...
static const char *group_names[] = { "keypad" };

void ui_create_groups() {
    if (!groups_created) {
        groups.keypad = lv_group_create();
